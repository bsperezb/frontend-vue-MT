...
methods: {
	getData: async function () {
		...
		axios.get(`https://ciclo3-api-backend.herokuapp.com/user/${userId}/`, 				//cambiar por el de mi backend
		// axios.get(`https://mision-tic-bank-be.herokuapp.com/user/${userId}/`, 				//cambiar por el de mi backend
	...
	verifyToken: function () {
		...
		return axios.post("https://ciclo3-api-backend.herokuapp.com/refresh/", 
